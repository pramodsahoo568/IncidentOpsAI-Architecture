...
The following diagram depicts the complete Agentic AI workflow implemented by
`incidentops_graph.py`: incident intake, LLM-based triage, RAG-backed requirement
validation, conditional routing, proposal generation, human approval, revision,
and final dry-run Jira creation.
...
*Figure 1: IncidentOpsAI LangGraph agent orchestration and human-in-the-loop workflow.*

The simplified system view below shows how the API, agents, OpenAI models, and
PGVector knowledge base interact at runtime:
